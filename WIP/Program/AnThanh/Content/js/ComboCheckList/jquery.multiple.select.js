...
(function ($) {
    ...
    MultipleSelect.prototype = {
        ...
        init: function () {
            ...
            if (this.options.width !== '' && this.options.width !== undefined && this.options.width !== null) {
                this.$drop.css('width', (this.$parent.width() - 0.2) + '%');
            } else {
                this.$drop.css('width', '100%');
            }
        ...
        getSelectVal: function (type) {
            ...
            if (_isCheckAll.prop('checked') == true && this.options.returnValues == false) {
    ...
    $.fn.multipleSelect = function () {
        var option = arguments[0],
            ...
            value,
            allowedMethods = [
                'getSelects', 'setSelects', 'getSelectVal',
                'enable', 'disable',
                'checkAll', 'uncheckAll',
                'focus', 'blur',
                'refresh'
