...
function ShowPopupDialog(divWrapperPopup, Title) {
    ...
    if ($("#btnExitPopups").length == 0) {
        $(".divPopup").prepend("<div class=divPopupHeader><b class=divTitlePopups>" + Title + "</b><a id=btnExitPopups href=javascript:; onclick=CloseDivAllStock('" + divWrapperPopup + "')><img src=/Content/Version2/icon/close.png style=float:right /></a></div>");
    }
...
function ShowPopupDialog(divWrapperPopup, Title, pWidth, pHeight) {
    ...
    if ($("#btnExitPopups").length == 0) {
        $(".divPopup").prepend("<div class=divPopupHeader ><b class=divTitlePopups>" + Title + "</b><a id=btnExitPopups href=javascript:; onclick=CloseDivAllStock('" + divWrapperPopup + "')><img src=/Content/Version2/Version2/Version2/icon/close1.png title=Close style=float:right;margin:10px /></a></div>");
...
function ShowPopupDialog(divWrapperPopup, Title, pWidth, pHeight, txtIdFocus) {
    ...
    var _width = pWidth + "px";
    if ($("#btnExitPopups").length == 0) {
        $(".divPopup").prepend("<div class=divPopupHeader ><b class=divTitlePopups>" + Title + "</b><a id=btnExitPopups href=javascript:; onclick=CloseDivAllStock('" + divWrapperPopup + "')><img src=/Content/Version2/icon/close1.png title=Close style=float:right;margin:10px /></a></div>");
        $(".divPopup").css({ "height": _heigt, "width": _width });
    }
    document.getElementById(divWrapperPopup).style.display = "block";
    var idFocus = "#" + txtIdFocus;
...
function ShowPopupDialog2(divWrapperPopup, Title) {
    ...
    if ($("#btnExitPopups2").length == 0) {
        $(".divPopup2").prepend("<div class=divPopupHeader2><b class=divTitlePopups2>" + Title + "</b><a id=btnExitPopups2 href=javascript:; onclick=CloseDivAllStock2('" + divWrapperPopup + "')><img src=/Content/Version2/icon/close1.png title=Close style=float:right;margin:10px /></a></div>");
    }
    document.getElementById(divWrapperPopup).style.display = "block";
