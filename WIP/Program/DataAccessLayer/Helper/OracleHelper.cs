...
namespace DataAccess
{
    public class OracleHelper
    {
        ...
        {
            // Pass through the call providing null for the set of OracleParameters
            return ExecuteNonQuery(connectionString, CommandType.Text, "Commit", (OracleParameter[])null);
        }
        ...
        public static int CommitToDB(string connectionString)
        {
            try
            {
                ...
                OracleHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, "pkg_chay_du_lieu.commit_to_db",
                 paramReturn
                 );
        ...
        {
            // Pass through the call providing null for the set of OracleParameters
            return ExecuteNonQuery(connectionString, CommandType.Text, "RollBack", (OracleParameter[])null);
        }
